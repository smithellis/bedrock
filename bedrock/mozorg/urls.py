...
urlpatterns = patterns('',
    ...
    page('contentservices/about', 'mozorg/contentservices/about.html'),
    page('contentservices/faq', 'mozorg/contentservices/faq.html'),
    url('^contentservices/start/$', views.content_services_start,
        name='mozorg.contentservices.start'),
    page('contentservices/tiles', 'mozorg/contentservices/tiles.html'),
    page('contentservices/user-respect', 'mozorg/contentservices/user-respect.html'),
